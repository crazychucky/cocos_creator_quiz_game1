System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, _decorator, Component, Node, _dec, _dec2, _class, _class2, _descriptor, _temp, _crd, ccclass, property, TestButton;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "417b3oObbVMD6v+dZBJfEKp", "TestButton", undefined);
      ...
      _export("TestButton", TestButton = (_dec = ccclass('TestButton'), _dec2 = property({
        type: Node
        ...
        _proto.onClick = function onClick() {
          console.log("click");
          this.btn.x = 50; // this.btn.active = false;
        };
